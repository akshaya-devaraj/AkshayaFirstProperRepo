...
function Leftbar() {
  ...
  return (
    ...
    <Button className='left-bar-btn' onClick={reserve}> <MeetingRoomIcon sx={{color:blue[900]}} fontSize='large'/></Button>
    <div className='profile'>Reservation</div>
    <Button className='left-bar-btn' onClick={dashboard}> <SpaceDashboardIcon sx={{color:blue[900]}} fontSize='large'/></Button>
   <div className='dashboard'>Dashboard</div>
    <Button className='left-bar-btn' onClick={billing}> <ReceiptIcon sx={{color:blue[900]}} fontSize='large' /></Button>
